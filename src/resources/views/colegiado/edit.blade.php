            ...
            <div class="form-group" id="professores">
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="professores_internos[]" id="professor_{{ $professor->id }}" value="{{ $professor->id }}" {{ $colegiado->professores->contains($professor->id) ? 'checked' : '' }}>
